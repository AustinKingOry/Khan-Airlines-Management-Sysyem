				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="file" class="form-control file-input" name="img" onchange="displayImg(this,$(this))">
							</div>
							<div class="form-group col-md-12 text-center border rounded mx-auto">
								<img src="" alt="" id="cimg" class="col-md-12">
							</div>	
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-warning col-sm-3" type="button" onclick="_reset()"> Reset</button>
							</div>
						</div>
					</div>
				</div>
